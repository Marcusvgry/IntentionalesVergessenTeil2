...
const cuedRecallTrial = {
    ...
    button_label: "Fertig",
    string_to_display:  ["Haut", "Heer", "Dampf", "Allee", "Baden", "Meer", "Blut", 
        "Buch", "Pelz", "Ecke", "Berg", "Vieh", "Grab", "Kalk", "Gift", "Kind",
         "Wald", "Seil", "Ofen", "Geld", "Erde", "Auto", "Tier", "Gold", "Apfel",
          "Boden", "Luft", "Brett", "Hose", "Eisen", "Fluss", "Moor"],
};
      ...
      pages: [
        {
          ...
          der Bearbeitung der Aufgabe irgendwelche Strategien eingesetzt haben, um die mit "VVV" gekennzeichneten Wörter zu vergessen.`,
            ...
            },
            {
                ...
                title: "Bitte beschreiben Sie die Strategie knapp in Ihren eigenen Worten.",
                isRequired: true,
                rows: 5,           
                cols: 70           
              },
        ...
        {
          name: 'page2',
            description:'Wir möchten Sie zum Abschluss noch bitten, einige demographische Daten anzugeben:',
            elements: [
                {
                    type: 'text',
