var jsPsychSurveyLikert = (function (jspsych) {
  ...
  class SurveyLikertPlugin {
    ...
    trial(display_element, trial) {
      ...
      html += ".jspsych-survey-likert-statement { display:block; font-size: 20px; padding-top: 40px; margin-bottom:10px; }.jspsych-survey-likert-opts { list-style:none; width:" + w + "; margin:auto; padding:0 0 20px; display:block; font-size: 18px; line-height:1.1em; }.jspsych-survey-likert-opt-label { line-height: 1.1em; color: #222; }.jspsych-survey-likert-opts:before { content: ''; position:relative; top:17px; /*left:9.5%;*/ display:block; background-color:#efefef; height:4px; width:100%; }.jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }.jspsych-survey-likert-opts li { display:inline-block; /*width:19%;*/ text-align:center; vertical-align: top; }";
      html += "</style>";
